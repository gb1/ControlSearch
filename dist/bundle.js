...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Details = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _npmSearch = __webpack_require__(220);
	...
	var Main = function (_React$Component) {
	    ...
	    _createClass(Main, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            (0, _npmSearch2.default)().then(function (res) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'container' },
	                    _react2.default.createElement(_Results2.default, { controls: this.state.controls, history: this.props.history })
	                )
	            );
	        }
	    }]);
	...
	var Search = function (_React$Component) {
	    ...
	    _createClass(Search, [{
	        ...
	        value: function handleSubmit() {
	            var username = this.searchTermRef.value;
	                    ...
	                    controls.map(function (control, index) {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'h5',
	                                null,
	                                control.data.author.name
	                            ),
	                            _react2.default.createElement(
	                                'h5',
	                                null,
	                                control.data.author.email
	                            ),
	                            _react2.default.createElement(
	                                'p',
	                                null,
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { onClick: _this2.moreInfo.bind(_this2, control.data) },
	                                'More info...'
	                            )
	                        );
	                    })
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getControls() {
	    return _axios2.default.get('/controls');
	}

	function getData() {
	    return _axios2.default.all([getControls()]).then(function (arr) {
	        return arr[0];
	    });
	}
